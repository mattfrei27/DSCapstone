...
Here I present a simple word prediction algorithm of my own design. It is is built on a large corpus of English text from the following three sources:
...
Code available on [github](https://github.com/mattfrei27/DSCapstone).
